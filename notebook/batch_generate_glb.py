...
def generate_animal_mesh_sequence(inference, image_folder, save_folder):
    ...
    animal_type = image_folder.split("/")[-3]
...
if __name__ == "__main__":
    ...
    animal_folder = "/scratch/cx2219/animal4d/pack_data/deer/pictures/"
    animal_list = os.listdir(animal_folder)
    for animal in animal_list:
        image_folder = os.path.join(animal_folder, animal)
        save_folder = "/scratch/cx2219/codebase/sam-3d-objects/notebook/results/"
